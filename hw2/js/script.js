...
//   // Show initial hands
//   show_bot_hand(bot1, "Bot1");
//   show_bot_hand(bot2, "Bot2");
...
//     // Show both hands after each turn
//     show_bot_hand(bot1, "Bot1");
//     show_bot_hand(bot2, "Bot2");
...
// function show_bot_hand(bot, bot_name) {
//   console.log(`${bot_name} Hand:`);
//   var colors = ["Blue", "Green", "Red", "Yellow"];
  
//   for (var color = 0; color < bot.hand.cards.length; color++) {
//     var color_cards = bot.hand.cards[color];
//     var numbers = color_cards[0];  // number cards
//     var actions = color_cards[1];  // action cards
    
//     if (numbers.length > 0 || actions.length > 0) {
//       console.log(`  ${colors[color]}:`);
      
//       if (numbers.length > 0) {
//         var number_list = numbers.map(card => `${card.numeric_value}`).join(", ");
//         console.log(`    Numbers: ${number_list}`);
//       }
      
//       if (actions.length > 0) {
//         var action_list = actions.map(card => {
//           if (card.numeric_value === -1) return "+2";
//           if (card.numeric_value === -2) return "Block";
//           if (card.numeric_value === -3) return "Reverse";
//           return card.type;
//         }).join(", ");
//         console.log(`    Actions: ${action_list}`);
//       }
//     }
//   }
  
//   if (bot.hand.card_count === 0) {
//     console.log(`  ${bot_name} has no cards!`);
//   }
// }
